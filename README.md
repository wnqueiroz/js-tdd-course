# Spotify Wrapper
[![Build Status](https://travis-ci.org/wnqueiroz/js-tdd-course.svg?branch=master)](https://travis-ci.org/wnqueiroz/js-tdd-course)
[![Coverage Status](https://coveralls.io/repos/github/wnqueiroz/js-tdd-course/badge.svg?branch=master)](https://coveralls.io/github/wnqueiroz/js-tdd-course?branch=master)
...
```sh
$ npm i @wnqueiroz/spotify-wrapper --save
```
...
| ![Willian Queiroz](https://avatars2.githubusercontent.com/u/22847781?v=3&s=150)|
|:---------------------:|
|  [Willian Queiroz](https://github.com/wnqueiroz/)   |

See also the list of [contributors](https://github.com/wnqueiroz/js-tdd-course/graphs/contributors) who participated in this project.
